...
},{"./emptyFunction":16}],33:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/invariant":15,"fbjs/lib/warning":17,"./lib/ReactPropTypesSecret":33}],10:[function(require,module,exports) {
...
},{"object-assign":14,"fbjs/lib/invariant":15,"fbjs/lib/emptyObject":22,"fbjs/lib/warning":17,"fbjs/lib/emptyFunction":16,"prop-types/checkPropTypes":21}],6:[function(require,module,exports) {
'use strict';
...
},{"./isNode":35}],18:[function(require,module,exports) {
'use strict';
...
},{"fbjs/lib/invariant":15,"react":6,"fbjs/lib/warning":17,"fbjs/lib/ExecutionEnvironment":19,"object-assign":14,"fbjs/lib/emptyFunction":16,"prop-types/checkPropTypes":21,"fbjs/lib/getActiveElement":20,"fbjs/lib/shallowEqual":25,"fbjs/lib/containsNode":18,"fbjs/lib/emptyObject":22,"fbjs/lib/hyphenateStyleName":24,"fbjs/lib/camelizeStyleName":23}],5:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":8}],39:[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=index.es.js.map
},{"@emotion/hash":39,"@emotion/stylis":37,"stylis-rule-sheet":36,"@emotion/memoize":34,"@emotion/unitless":38}],13:[function(require,module,exports) {
...
//# sourceMappingURL=index.es.js.map
},{"create-emotion":28}],32:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/emptyFunction":16,"fbjs/lib/invariant":15,"fbjs/lib/warning":17,"object-assign":14,"./lib/ReactPropTypesSecret":33,"./checkPropTypes":21}],26:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithTypeCheckers":32}],27:[function(require,module,exports) {
'use strict';
...
exports.default = index;
//# sourceMappingURL=index.es.js.map
},{"@emotion/memoize":34}],12:[function(require,module,exports) {
'use strict';
...
//# sourceMappingURL=index.es.js.map
},{"prop-types":26,"@emotion/is-prop-valid":27}],7:[function(require,module,exports) {
'use strict';
...
//# sourceMappingURL=index.es.js.map
exports.default = index;
},{"react":6,"emotion":13,"create-emotion-styled":12}],3:[function(require,module,exports) {
module.exports="/Futura.36b06bec.ttc";
},{}],11:[function(require,module,exports) {
module.exports="/background.ed0f7276.png";
...
var _background = require('./pictures/background.png');
...
var Event = function Event(props) {
    return _react2.default.createElement(
        'div',
        {
            className: (0, _emotion.css)(eventStyle)
        },
        ...
        _react2.default.createElement(
            'span',
            {
                className: /*#__PURE__*/(0, _emotion.css)('margin-left:5px;')
            },
            props.eventName
        )
    );
...
var Arrow = function Arrow(_ref) {
    ...
    if (value > 0) {
        return _react2.default.createElement(
            'span',
            { id: 'current-percent', className: /*#__PURE__*/(0, _emotion.css)('color:rgb(16,216,16);')
            },
            value,
            '% \u25B2'
        );
        ...
        return _react2.default.createElement(
            'span',
            { id: 'current-percent', className: /*#__PURE__*/(0, _emotion.css)('color:red;')
            },
            value,
            '% \u25BC'
        );
...
var Block = function Block(_ref2) {
    ...
    var currentBlockStyle = block;
    if (length == 1 || length == 2) {
        currentBlockStyle = singleBlock;
    }
    return _react2.default.createElement(
        'div',
        { className: currentBlockStyle },
        _react2.default.createElement(
            'div',
            { id: 'top-side' },
            _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('img', { id: 'icon-style', src: currency.logo }),
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement('br', null),
                _react2.default.createElement(Arrow, { value: currency.percent })
            )
        ),
        ...
        _react2.default.createElement(
            'div',
            {
                className: (0, _emotion.css)(blockBottom)
            },
            _react2.default.createElement(
                'div',
                {
                    className: /*#__PURE__*/(0, _emotion.css)('display:flex;justify-content:space-between;')
                },
                _react2.default.createElement(
                    'span',
                    { id: 'market-capacity' },
...
var CryptoApp = exports.CryptoApp = function (_React$Component) {
    _inherits(CryptoApp, _React$Component);

    function CryptoApp() {
        _classCallCheck(this, CryptoApp);

        return _possibleConstructorReturn(this, (CryptoApp.__proto__ || Object.getPrototypeOf(CryptoApp)).apply(this, arguments));
    }
    ...
    _createClass(CryptoApp, [{
        ...
        value: function render() {
            ...
            var d = new Date();
            var time = new Intl.DateTimeFormat('en-GB', { timeZone: "Europe/Istanbul", hour12: false, hour: '2-digit', minute: '2-digit' }).format(d);
            var date = new Intl.DateTimeFormat('en-GB', { timeZone: "Europe/Istanbul", hour12: false, day: '2-digit', month: 'numeric', year: 'numeric' }).format(d);
            var currentStyle = '';
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'span',
                        {
                            className: /*#__PURE__*/(0, _emotion.css)('margin-left:20px;')
                        },
                        date
                    ),
                    _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.props.data.map(function (currency) {
                        return _react2.default.createElement(Block, { currency: currency, length: _this2.props.data.length });
                    })
                )
            );
        }
...
var container = /*#__PURE__*/(0, _reactEmotion.css)('width:100%;height:100%;box-sizing:border-box;background:url(', _background2.default, ');background-repeat:no-repeat;background-size:cover;background-position:center;& *{box-sizing:border-box;font-family:Futura;color:white;}');

var header = /*#__PURE__*/(0, _reactEmotion.css)('width:100%;height:65px;background:rgba(0,0,0,0.8);padding:0 30px;line-height:65px;font-size:25px;span{float:right;}');

var blockContainer = /*#__PURE__*/(0, _reactEmotion.css)('width:100%;height:calc(100% - 65px);display:grid;grid-template-columns:auto auto auto auto;grid-template-rows:31.5% 31.5% 31.5%;grid-column-gap:45px;grid-row-gap:30px;padding:20px;');

var blockContainerSingle = /*#__PURE__*/(0, _reactEmotion.css)('width:100%;height:calc(100% - 65px);display:grid;justify-content:center;align-items:center;grid-template-columns:600px;padding:20px;');

var blockContainerDouble = /*#__PURE__*/(0, _reactEmotion.css)('width:100%;height:calc(100% - 65px);display:grid;justify-content:center;align-content:center;grid-template-columns:650px 650px;grid-template-rows:31.5%;grid-column-gap:10%;');

var blockBottomTriple = /*#__PURE__*/(0, _reactEmotion.css)('width:100%;height:calc(100% - 65px);display:grid;align-content:center;justify-content:center;grid-template-columns:450px 450px 450px;grid-template-rows:30.5%;grid-column-gap:8%;');

var blockContainerFour = /*#__PURE__*/(0, _reactEmotion.css)('width:100%;height:calc(100% - 65px);display:grid;align-content:center;justify-content:center;grid-template-columns:500px 500px;grid-template-rows:30.5% 30.5%;grid-column-gap:10%;grid-row-gap:15%;');

var blockStyles = new Map();
...
var block = /*#__PURE__*/(0, _reactEmotion.css)('border:2px solid rgba(100,100,100,0.7);border-radius:5px;padding:20px;background:rgba(0,0,0,0.5);#top-side{display:flex;justify-content:space-between;}#icon-style{width:64px;height:64px;}#name{font-size:25px;}#current-value{font-size:50px;}#current-percent{font-size:30px;float:right;padding-top:10px;}hr{opacity:0.7;}#marked-capacity{font-size:23px;}#circulating-supply{font-size:23px;}');

var singleBlock = /*#__PURE__*/(0, _reactEmotion.css)('border-radius:5px;padding:20px;background:rgba(0,0,0,0.5);#top-side{display:flex;justify-content:space-between;}#icon-style{width:64px;height:64px;margin:15px 0 20px 10px;}#name{font-size:30px;}#current-value{font-size:60px;}#current-percent{font-size:40px;float:right;padding-top:10px;}hr{opacity:0.7;}#market-capacity{font-size:26px;}#circulating-supply{font-size:26px;}');

var blockBottom = /*#__PURE__*/(0, _reactEmotion.css)('display:flex;flex-direction:column;padding:5% 0;font-size:23px;line-height:200%;');
},{"emotion":13,"react":6,"react-emotion":7,"./pictures/background.png":11}],9:[function(require,module,exports) {
module.exports="/bitcoin.8bd7e716.png";
...
exports.CryptoAppFour = undefined;
...
var _bitcoin = require('../icons/bitcoin.png');
...
var Arrow = function Arrow(_ref) {
    ...
    if (value > 0) {
        return _react2.default.createElement(
            'span',
            {
                className: /*#__PURE__*/(0, _emotion.css)('font-size:0.8em')
            },
            '\u25B2'
        );
    } else {
        return _react2.default.createElement(
            'span',
            {
                className: /*#__PURE__*/(0, _emotion.css)('font-size:0.8em;color:red;')
            },
            ' \u25BC'
        );
    }
...
var Block = function Block(_ref2) {
    var name = _ref2.name,
        ...
        currentPercent = _ref2.currentPercent,
        markedCap = _ref2.markedCap,
        circulatingSupply = _ref2.circulatingSupply;
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('img', { id: 'icon-style', src: _bitcoin2.default }),
                _react2.default.createElement('br', null),
                _react2.default.createElement(
                    'span',
                    { id: 'name' },
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    currentPercent,
                    '% ',
                    _react2.default.createElement(Arrow, { value: currentPercent })
                )
            )
        ),
        _react2.default.createElement('hr', null),
...
var CryptoAppFour = exports.CryptoAppFour = function (_React$Component) {
    _inherits(CryptoAppFour, _React$Component);

    function CryptoAppFour() {
        _classCallCheck(this, CryptoAppFour);

        return _possibleConstructorReturn(this, (CryptoAppFour.__proto__ || Object.getPrototypeOf(CryptoAppFour)).apply(this, arguments));
    }

    _createClass(CryptoAppFour, [{
        key: 'render',
        value: function render() {
            var d = new Date();
            var time = new Intl.DateTimeFormat('en-GB', { timeZone: "Europe/Istanbul", hour12: false, hour: '2-digit', minute: '2-digit' }).format(d);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(Block, { name: 'Bitcoin', currentValue: '752,22', currentPercent: '-0.43',
...
var blockContainer = /*#__PURE__*/(0, _reactEmotion.css)('width:100%;height:calc(100% - 65px);display:grid;align-content:center;justify-content:center;grid-template-columns:500px 500px;grid-template-rows:30.5% 30.5%;grid-column-gap:10%;grid-row-gap:15%;');

var block = /*#__PURE__*/(0, _reactEmotion.css)('border:2px solid rgba(100,100,100,0.7);border-radius:5px;padding:20px;background:rgba(0,0,0,0.5);#top-side{display:flex;justify-content:space-between;}#icon-style{width:64px;height:64px;}#name{font-size:25px;}#current-value{font-size:42px;}#current-percent{font-size:30px;color:red;float:right;padding-top:10px;}hr{opacity:0.7;}#marked-capacity{font-size:23px;}#circulating-supply{font-size:23px;}');

var blockBottom = /*#__PURE__*/(0, _reactEmotion.css)('display:flex;flex-direction:column;padding:5% 0;font-size:23px;line-height:200%;');
},{"emotion":13,"react":6,"react-emotion":7,"../icons/bitcoin.png":9,"./pictures/background.png":11}],60:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.CryptoAppTree = undefined;
...
var CryptoAppTree = exports.CryptoAppTree = function (_React$Component) {
    _inherits(CryptoAppTree, _React$Component);

    function CryptoAppTree() {
        _classCallCheck(this, CryptoAppTree);

        return _possibleConstructorReturn(this, (CryptoAppTree.__proto__ || Object.getPrototypeOf(CryptoAppTree)).apply(this, arguments));
    }

    _createClass(CryptoAppTree, [{
        key: 'render',
        value: function render() {
            var d = new Date();
            var time = new Intl.DateTimeFormat('en-GB', { timeZone: "Europe/Istanbul", hour12: false, hour: '2-digit', minute: '2-digit' }).format(d);
...
var blockContainer = /*#__PURE__*/(0, _reactEmotion.css)('width:100%;height:calc(100% - 65px);display:grid;justify-content:center;align-content:center;grid-template-columns:450px 450px 450px;grid-column-gap:5%;padding:20px;');

var block = /*#__PURE__*/(0, _reactEmotion.css)('border:2px solid rgba(100,100,100,0.7);border-radius:5px;padding:20px;background:rgba(0,0,0,0.5);#top-side{display:flex;justify-content:space-between;}#icon-style{width:64px;height:64px;}#name{font-size:25px;}#current-value{font-size:42px;}#current-percent{font-size:30px;color:red;float:right;padding-top:10px;}hr{opacity:0.7;}#marked-capacity{font-size:23px;}#circulating-supply{font-size:23px;}');

var blockBottom = /*#__PURE__*/(0, _reactEmotion.css)('display:flex;flex-direction:column;padding:5% 0;font-size:23px;line-height:200%;');
},{"emotion":13,"react":6,"react-emotion":7,"../icons/bitcoin.png":9,"./pictures/background.png":11}],2:[function(require,module,exports) {
'use strict';
...
var _Futura = require('./fonts/Futura.ttc');

var _Futura2 = _interopRequireDefault(_Futura);

var _CryptoApp = require('./CryptoApp');

var _CryptoAppFour = require('./CryptoAppFour');

var _CryptoAppTree = require('./CryptoAppTree');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactEmotion.injectGlobal)('@font-face{font-family:\'Futura\';src:url(', _Futura2.default, ') format(\'truetype\');}');
...
var App = function App() {
  return _react2.default.createElement(
    'div',
    { className: appStyle },
    _react2.default.createElement(_CryptoApp.CryptoApp, { data: data })
  );
};

_reactDom2.default.render(_react2.default.createElement(App, null), document.getElementById('root'));
},{"react":6,"react-dom":5,"react-emotion":7,"./fonts/Futura.ttc":3,"./CryptoApp":53,"./CryptoAppFour":52,"./CryptoAppTree":60}],90:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.266c4bdd.map